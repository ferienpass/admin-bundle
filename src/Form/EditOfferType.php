...
class EditOfferType extends AbstractType implements FormSubscriberAwareInterface
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('minAge', IntegerType::class, ['attr' => ['placeholder' => 'kein Mindestalter', 'min' => 0], 'fieldset_group' => 'details', 'width' => '1/3'])
            ->add('maxAge', IntegerType::class, ['attr' => ['placeholder' => 'kein Höchstalter', 'min' => 0], 'fieldset_group' => 'details', 'width' => '1/3'])
            ->add('meetingPoint', null, ['fieldset_group' => 'details', 'width' => '1/2'])
            ->add('bring', null, ['fieldset_group' => 'details', 'width' => '1/2'])
            ->add('fee', MoneyType::class, ['attr' => ['min' => 0], 'divisor' => 100, 'html5' => true, 'fieldset_group' => 'details', 'width' => '1/3'])
